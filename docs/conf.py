...
try:
    from mqt.misim import __version__ as version
except ModuleNotFoundError:
    try:
        version = metadata.version("mqt.misim")
    except ModuleNotFoundError:
        msg = (
...
modindex_common_prefix = ["mqt.misim."]
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/cda-tum/mqt-misim/",
    "source_branch": "main",
...
latex_documents = [
    (
        master_doc,
        "mqt_misim.tex",
        r"MQT MiSiM\\{\Large A Tool for the Simulation of Mixed-Dimensional Quantum Circuits based on Decision Diagrams}",
