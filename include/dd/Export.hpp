...
namespace dd {
    ...
    [[maybe_unused]] static std::ostream& bwEdge(
            const MDDPackage::vEdge& from, const MDDPackage::vEdge& to, short idx,
    ...
    [[maybe_unused]] static std::ostream& coloredEdge(const MDDPackage::mEdge& from,
                                                      const MDDPackage::mEdge& to,
                                                      short idx, std::ostream& os,
                                                      bool edgeLabels    = false,
                                                      bool classic       = false,
    ...
    [[maybe_unused]] static void serialize(const MDDPackage::vEdge& basic,
                                           std::ostream&            os,
        ...
        std::stack<const MDDPackage::vEdge*> stack{};
    ...
    static void serializeMatrix(
            const MDDPackage::mEdge& basic, std::int_least64_t& idx,
            std::unordered_map<MDDPackage::mNode*, std::int_least64_t>& node_index,
    ...
    [[maybe_unused]] static void serialize(const MDDPackage::mEdge& basic,
                                           std::ostream&            os,
                                           bool                     writeBinary = false) {
        if (writeBinary) {
            os.write(reinterpret_cast<const char*>(&SERIALIZATION_VERSION),
        ...
        std::unordered_map<MDDPackage::mNode*, std::int_least64_t> node_index{};
        std::unordered_set<MDDPackage::mNode*>                     visited{};
