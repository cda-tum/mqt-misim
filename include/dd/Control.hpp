...
namespace dd {
    ...
    inline namespace literals {
        ...
        // inline Control operator""_nc(unsigned long long int qreg) { return
        // {static_cast<QuantumRegister>(qreg), Control::Type::neg}; } inline
        // Control operator""_nc(unsigned long long int qreg) { return
        // {static_cast<QuantumRegister>(qreg), Control::Type::neg}; }
    } // namespace literals
} // namespace dd
